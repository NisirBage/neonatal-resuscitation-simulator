...
VOICE_PROMPTS: dict[str, str] = {
    ...
    "measure_heart_rate":           "Measure heart rate.",
    "heart_rate_assessment":        "Is the heart rate greater than 100 beats per minute?",
    ...
    "ventilation_corrective_steps": "Follow ventilation corrective steps and measure heart rate every 15 seconds.",
    "ventilation_corrective_buffer": "Corrective ventilation in progress.",
...
CSV_PROMPTS: dict[str, str] = {
    ...
    "apnea_assessment":             "DOES BABY HAVE APNEA",
    "measure_heart_rate":           "MEASURE HEART RATE",
    "heart_rate_assessment":        "IS HR GREATER THAN 100 BPM",
...
CLINICAL_PHASES: dict[str, str] = {
    ...
    "measure_heart_rate":           "Heart Rate Assessment",
    ...
    "ventilation_corrective_buffer": "Corrective Ventilation",
...
INSTRUCTOR_ACTION_LABELS: dict[str, str] = {
    ...
    "corrective_ventilation_buffer_complete": "Instructor skipped timer",
    "advance_to_hr_check":                    "Instructor advanced simulation",
}
